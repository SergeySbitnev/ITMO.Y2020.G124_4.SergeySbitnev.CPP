...
int main()
{
    ...
    cout << "Данная программа вычисляет площадь выпуклого пятиугольника, через сумму площадей его треугольников.\n";
    cout << "Координаты вершин введены в тексте программы.\n";
    a = Side(x1, y1, x2, y2);
    b = Side(x2, y2, x3, y3);
    c = Side(x3, y3, x4, y4);
    d = Side(x4, y4, x5, y5);
    ...
    cout << "Площадь нашего пятиугольна = " << SquarePolygon << endl;
    return 0;
}
